    ...
    <MenuBar />
          ...
          <div className="row p-2">
            <div className="col-12">
              <div className="address border border-dark border-2 ">
                ...
                <div className="row">
                  <div className="col-12">
                    <h5 className="mb-3">Office Equipment <br /> As at 30 June 2023</h5>
                  </div>
                </div>
              </div>
            </div>
      ...
      <table className='width table table-bordered'>
        ...
        <tr>
          ...
          <td className='border border-dark border-2'>Equipment</td>
          <td className='border border-dark border-2'></td>
          <td className='border border-dark border-2'></td>
          <td className='border border-dark border-2'></td>
          <td className='border border-dark border-2'></td>
        ...
        <tr>
          ...
          <td className='border border-dark'>
            <input className="input-group input-group-sm input" type="text" placeholder='equipment' />
            </td>
          <td className='border border-dark'>
